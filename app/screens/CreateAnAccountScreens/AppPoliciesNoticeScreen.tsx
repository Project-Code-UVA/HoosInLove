        ...
        <View style={styles.card}>
          ...
          <ScrollView style={styles.scrollContent}>
            ...
            <View style={styles.bulletList}>
              {['Sexual Misconduct & Harassment', 'Misrepresentation & Scamming', 'Threatening or Abusive Behavior', 'Hate Speech', 'Spam & Bots', 'Multiple Violations of Community Guidelines'].map((item, index) => (
...
const styles = StyleSheet.create({
  ...
  card: { width: '85%', maxHeight: '80%', backgroundColor: '#FFFFFF', borderRadius: 12, padding: 24, elevation: 5 },
  title: { fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginBottom: 16 },
  scrollContent: { flexGrow: 0, marginBottom: 16 },
  mainText: { fontSize: 14, color: '#333', lineHeight: 20, marginBottom: 12 },
  bulletList: { marginLeft: 8, marginBottom: 16 },
  bullet: { fontSize: 14, color: '#333', lineHeight: 24, marginBottom: 4 },
  footerText: { fontSize: 14, color: '#333', lineHeight: 20 },
